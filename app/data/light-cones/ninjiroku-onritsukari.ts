...
// NOTE: The name "忍事録・音律狩猟" appears to be a non-standard name.
// The effect description matches "The Unreachable Side" (此岸の向こう).
// Using a sanitized version of the user-provided name for the filename.
export const ninjirokuOnritsukari: ILightConeData = {
  id: 'ninjiroku-onritsukari',
  name: '忍事録・音律狩猟',
  path: 'Destruction',
  baseStats: {
    hp: 1058,
