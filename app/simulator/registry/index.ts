...
import { theHertaHandlerFactory } from '../../data/characters/the-herta';
...
import { robinHandlerFactory } from '../../data/characters/robin';
import { saberHandlerFactory } from '../../data/characters/saber';
import { seeleHandlerFactory } from '../../data/characters/seele';
import { sparkleHandlerFactory } from '../../data/characters/sparkle';
import { silverWolfHandlerFactory } from '../../data/characters/silver-wolf';
import { dahliaHandlerFactory } from '../../data/characters/dahlia';
import { jadeHandlerFactory } from '../../data/characters/jade';
import { jingYuanHandlerFactory } from '../../data/characters/jing-yuan';
import { lingshaHandlerFactory } from '../../data/characters/lingsha';
import { mydeiHandlerFactory } from '../../data/characters/mydei';
import { rappaHandlerFactory } from '../../data/characters/rappa';
import { topazAndNumbyHandlerFactory } from '../../data/characters/topaz-and-numby';
import { trailblazerDestructionHandlerFactory } from '../../data/characters/trailblazer-destruction';
import { trailblazerPreservationHandlerFactory } from '../../data/characters/trailblazer-preservation';
import { weltHandlerFactory } from '../../data/characters/welt';
import { yanqingHandlerFactory } from '../../data/characters/yanqing';
import { yunliHandlerFactory } from '../../data/characters/yunli';
...
registry.registerCharacter('the-herta', theHertaHandlerFactory);
...
registry.registerCharacter('robin', robinHandlerFactory);
registry.registerCharacter('seele', seeleHandlerFactory);
registry.registerCharacter('sparkle', sparkleHandlerFactory);
registry.registerCharacter('silver-wolf', silverWolfHandlerFactory);
registry.registerCharacter('dahlia', dahliaHandlerFactory);
registry.registerCharacter('saber', saberHandlerFactory);
registry.registerCharacter('jade', jadeHandlerFactory);
registry.registerCharacter('jing-yuan', jingYuanHandlerFactory);
registry.registerCharacter('lingsha', lingshaHandlerFactory);
registry.registerCharacter('mydei', mydeiHandlerFactory);
registry.registerCharacter('rappa', rappaHandlerFactory);
registry.registerCharacter('topaz-and-numby', topazAndNumbyHandlerFactory);
registry.registerCharacter('trailblazer-destruction', trailblazerDestructionHandlerFactory);
registry.registerCharacter('trailblazer-preservation', trailblazerPreservationHandlerFactory);
registry.registerCharacter('welt', weltHandlerFactory);
registry.registerCharacter('yanqing', yanqingHandlerFactory);
registry.registerCharacter('yunli', yunliHandlerFactory);
